...
public class AdvertismentPublished extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_advertisment_published);
        ...
        Button b = (Button) findViewById(R.id.btn_add_adv);
