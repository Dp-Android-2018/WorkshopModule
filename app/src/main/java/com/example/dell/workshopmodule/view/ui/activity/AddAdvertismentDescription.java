...
public class AddAdvertismentDescription extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_advertisment_description_layout);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(),AddAdvertismentCountry.class);
                startActivity(i);
            }
        });
    }
