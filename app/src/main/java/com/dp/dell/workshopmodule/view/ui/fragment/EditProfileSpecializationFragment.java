...
import com.dp.dell.workshopmodule.view.ui.dialog.SubmitEditProfileDialog;
...
public class EditProfileSpecializationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_edit_profile_specialization_layout,container,false);
